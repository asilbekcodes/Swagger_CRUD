...
function Product() {
  ...
  return (
    <>
    <AdminHeader />
    <div className='container mx-auto my-5 h-[54vh]'>
      <h4 className='text-3xl font-serif font-bold text-green-500 mb-5'>Products</h4>
          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
              <div class="relative bg-white rounded-lg shadow drop-shadow-2xl ">
                  ...
                  <div class="p-4 md:p-5 text-center">
                      ...
                      <button onClick={deleteProduct} data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                          Yes, I'm sure
                      </button>
